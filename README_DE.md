...
**Hinweis:** `./start.sh` prüft, ob bereits installiert ist; wenn nicht, startet automatisch die Installation (`scripts/install.sh`).

**Schnell: Alles einrichten + updaten + testen:** Siehe [INSTALL_UND_TEST.md](INSTALL_UND_TEST.md). Nach Installation von Python 3.12 einmal `./scripts/install.sh` ausführen.
